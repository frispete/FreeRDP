...
LPSTR freerdp_get_dynamic_addin_install_path(void)
{
	...
	WLog_WARN(TAG, "freerdp_get_dynamic_addin_install_path <- pszInstallPrefix: %s, pszAddinPath: %s", pszInstallPrefix, pszAddinPath);
	...
	WLog_WARN(TAG, "freerdp_get_dynamic_addin_install_path -> pszPath: %s", pszPath);
                                                ...
                                                LPCSTR pszEntryName)
{
	...
	WLog_WARN(TAG, "freerdp_load_dynamic_addin <- pszFileName: %s, pszPath: %s, pszEntryName: %s", pszFileName, pszPath, pszEntryName);
